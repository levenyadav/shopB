...
// SPEC §6.1 — Purchase Entry. Add a new item with its opening stock.
// Save sequence honours Golden Rule #1: insert items (quantity 0), then insert a
// purchase row; the DB trigger raises stock, supplier balance and the ledger.
const BLANK = {
